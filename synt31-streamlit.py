...
with menu_cols[4]:
    # --- Modification Start: Button Enable Logic ---
    # Check if the current structure (optimized or nominal) is suitable for removal
    ...
    # Use the structural check to enable/disable the button
